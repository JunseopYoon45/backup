...
--	            ELSE 'Z' END AMT_XYZ	            
	...
	MERGE INTO TB_BF_ITEM_STATS A USING (
		...
		SELECT ITEM_CD, LOCAT_CD, ACCRCY FROM FINAL) B
		ON (A.ITEM_CD = B.ITEM_CD AND A.LOCAT_CD = B.LOCAT_CD)
		WHEN MATCHED THEN 
		UPDATE SET A.ACCRCY = B.ACCRCY
		WHEN NOT MATCHED THEN
		INSERT (ITEM_CD, LOCAT_CD, ACCRCY) VALUES (B.ITEM_CD, B.LOCAT_CD, B.ACCRCY)
		;
